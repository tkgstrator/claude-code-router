      ...
      >
        ...
        <div className='space-y-4 p-4 px-8 overflow-y-auto flex-1'>
          <div className='flex items-center space-x-2'>
            ...
            <Label htmlFor='log' className='transition-all-ease hover:scale-[1.02] cursor-pointer'>
              {t('toplevel.log')}
            </Label>
          </div>
          ...
          <div className='space-y-2 border-t pt-4'>
            <div className='flex items-center justify-between'>
              <div className='flex items-center space-x-2'>
                ...
                />
                <Label htmlFor='statusline' className='transition-all-ease hover:scale-[1.02] cursor-pointer'>
                  {t('statusline.title')}
                </Label>
              </div>
              <Button
          ...
          <div className='space-y-2'>
            <Label htmlFor='log-level' className='transition-all-ease hover:scale-[1.01] cursor-pointer'>
          ...
          <div className='space-y-2'>
            <Label htmlFor='claude-path' className='transition-all-ease hover:scale-[1.01] cursor-pointer'>
          ...
          <div className='space-y-2'>
            <Label htmlFor='host' className='transition-all-ease hover:scale-[1.01] cursor-pointer'>
              {t('toplevel.host')}
            </Label>
            <Input
              id='host'
          ...
          <div className='space-y-2'>
            <Label htmlFor='port' className='transition-all-ease hover:scale-[1.01] cursor-pointer'>
              {t('toplevel.port')}
            </Label>
            <Input
              id='port'
          ...
          <div className='space-y-2'>
            <Label htmlFor='timeout' className='transition-all-ease hover:scale-[1.01] cursor-pointer'>
              {t('toplevel.timeout')}
            </Label>
            <Input
              id='timeout'
          ...
          <div className='space-y-2'>
            <Label htmlFor='proxy-url' className='transition-all-ease hover:scale-[1.01] cursor-pointer'>
          ...
          <div className='space-y-2'>
            <Label htmlFor='apikey' className='transition-all-ease hover:scale-[1.01] cursor-pointer'>
              {t('toplevel.apikey')}
            </Label>
            <Input
              id='apikey'
          ...
          <div className='space-y-2'>
            <Label htmlFor='custom-router-path' className='transition-all-ease hover:scale-[1.01] cursor-pointer'>
