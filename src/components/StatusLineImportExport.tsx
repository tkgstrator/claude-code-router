      ...
      <CardContent className='space-y-4 px-4 pb-4'>
        <div className='grid grid-cols-1 sm:grid-cols-2 gap-3'>
          <div className='grid grid-cols-2 gap-3'>
            <Button onClick={handleExport} variant='outline' className='transition-all hover:scale-105'>
              <svg
                xmlns='http://www.w3.org/2000/svg'
                width='16'
                height='16'
          ...
          <div className='grid grid-cols-2 gap-3'>
            <Button onClick={handleBackup} variant='outline' className='transition-all hover:scale-105'>
              <svg
                xmlns='http://www.w3.org/2000/svg'
                width='16'
                height='16'
        ...
        <div className='p-3 bg-secondary/50 rounded-md'>
          <div className='flex items-start gap-2'>
            ...
            <div>
              <p className='text-xs text-muted-foreground'>{t('statusline.import_export_help')}</p>
            </div>
          </div>
        </div>
      </CardContent>
