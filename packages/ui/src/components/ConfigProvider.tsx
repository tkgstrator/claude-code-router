...
export function ConfigProvider({ children }: ConfigProviderProps) {
          ...
          StatusLine:
            data.StatusLine && typeof data.StatusLine === 'object'
              ? {
                  ...
                  currentStyle:
                    typeof data.StatusLine.currentStyle === 'string' ? data.StatusLine.currentStyle : 'default',
                  default:
  ...
  return <ConfigContext.Provider value={{ config, setConfig, error }}>{children}</ConfigContext.Provider>
}
