...
import { type ExportOptions, exportPreset as exportPresetCore } from '@ccr/shared'
 ...
 */
export async function exportPresetCli(presetName: string, options: ExportOptions = {}): Promise<void> {
  try {
    console.log(`\n${BOLDCYAN}═══════════════════════════════════════════════${RESET}`)
